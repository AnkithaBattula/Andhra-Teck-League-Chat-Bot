class Chatbox {
    constructor() {
        this.args = {
            ...
            textField: document.querySelector('.chatbox__input') ,// Add input field reference
        ...
        // Add delay before adding introductory messages
        this.delay(1000).then(() => {
          ...
          return this.delay(2000); // Delay for 2 seconds
      }).then(() => {
          this.messages.push({
              name: "Sam",
